...
<body>
    ...
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn" onclick="if(prompt('Enter Manager PIN:')==='1234'){window.location.href='manager_panel.php';}else{alert('Access Denied');return false;}"><i class="fa-solid fa-user-tie" style="margin-left: 5px; font-size: 1.2rem; color: #555;"></i>&nbsp&nbsp&nbsp Manager Controls</li>
        </ul>
    </nav>
